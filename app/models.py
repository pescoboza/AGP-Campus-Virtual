...
QUIZ_CODES = {
    "tstc":{"is_obligatory": True , "num_questions":3,  "score_to_pass": 3}, # Cancer testicular
    "crvu":{"is_obligatory": True , "num_questions":3,  "score_to_pass": 3}, # Cancer cervicouterino
    "plmn":{"is_obligatory": True , "num_questions":3,  "score_to_pass": 3}, # Cancer en pulmon
    "psta":{"is_obligatory": True , "num_questions":3,  "score_to_pass": 3}, # Cancer en prostata
    "mama":{"is_obligatory": True , "num_questions":3,  "score_to_pass": 3}, # Cancer de mama
    "diag":{"is_obligatory": False, "num_questions":10, "score_to_pass": 0}  # Examen diagnostico
}
